...
export const ConsolidationOfAccounts = (
  <div className="left">
    <div>
      <label>Broker’s Indemnity</label>
    ...
    <div>
      <label>Banker’s Confirmation of Signature </label>
      <div className="file-input">
        <input type="file" />
        <span className="button">SELECT</span>
        <span className="label" data-js-label>
    ...
    <div>
      <label>Sworn Affidavit issued by the High Court</label>
      <div className="file-input">
        <input type="file" />
        <span className="button">SELECT</span>
        <span className="label" data-js-label>
    ...
    <div>
      <label>CSCS Statement of Account </label>
      <div className="file-input">
        <input type="file" />
        <span className="button">SELECT</span>
        <span className="label" data-js-label>
